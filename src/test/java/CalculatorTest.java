...
public class CalculatorTest {
    ...
    public void testingComputePower(){
        ...
        assertNotEquals("computing Power", 32, calculator.computeFactorial(2, 4), DELTA);
    }
    
    @Test
    public void testingComputeLog(){
        assertEquals("computing Natural Log", 0, calculator.computeLog(1), DELTA);
        assertNotEquals("computing Natural Log", 32, calculator.computeFactorial(2.1), DELTA);
    }
    
    @Test
    public void testingComputeSQ(){
        assertEquals("computing SQ", 7, calculator.computeSQ(49), DELTA);
        assertNotEquals("computing SQ", 4, calculator.computeFactorial(4), DELTA);
    }
}
